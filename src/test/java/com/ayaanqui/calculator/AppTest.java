...
public class AppTest {
    ...
    public void testAdditionAndSubtraction() {
        ...
        calculator.setUp("1+1-1-1");
        assertEquals("0.0", calculator.solveExpression());

        calculator.setUp("21344-8822-82+123-12-3485.123");
        assertEquals("9065.877", calculator.solveExpression());

        calculator.setUp("-1+-1");
        assertEquals("-2.0", calculator.solveExpression());

        calculator.setUp("28--25+056.200+-14");
    ...
    public void testMultiplicationDivision() {
        ...
        calculator.setUp("0*1");
        assertEquals("0.0", calculator.solveExpression());

        calculator.setUp("4*0");
        assertEquals("0.0", calculator.solveExpression());

        calculator.setUp("2349*133*1249");
        assertEquals("3.90208833E8", calculator.solveExpression());

        // Division
        calculator.setUp("0/198");
        assertEquals("0.0", calculator.solveExpression());

        calculator.setUp("4/2");
        assertEquals("2.0", calculator.solveExpression());

        calculator.setUp("384/13/1933");
    ...
    public void testExponents() {
        ...
        calculator.setUp("0^1393");
        assertEquals("1.0", calculator.solveExpression());

        calculator.setUp("pi^2");
        assertEquals("9.869604401089358", calculator.solveExpression());

        calculator.setUp("2^2^2");
    ...
    public void testMathFunctions() {
        ...
        calculator.setUp("sin(0)");
        assertEquals("0.0", calculator.solveExpression());

        calculator.setUp("sin(pi)");
        assertEquals("1.2246467991473532E-16", calculator.solveExpression());

        calculator.setUp("cos(0)");
        assertEquals("1.0", calculator.solveExpression());

        calculator.setUp("cos(pi)");
        assertEquals("-1.0", calculator.solveExpression());

        calculator.setUp("cos(4958.111+35-e)");
        assertEquals("0.02720869756712837", calculator.solveExpression());

        calculator.setUp("sin(-pi/2)");
        assertEquals("-1.0", calculator.solveExpression());

        calculator.setUp("tan(0.000134566+cos(pi+1)-1*2)");
        assertEquals("0.6862306858063052", calculator.solveExpression());

        calculator.setUp("sqrt(4)");
        assertEquals("2.0", calculator.solveExpression());

        calculator.setUp("sqrt(4858.001)");
        assertEquals("69.69936154657373", calculator.solveExpression());

        calculator.setUp("ln(e)");
        assertEquals("1.0", calculator.solveExpression());

        calculator.setUp("sin(pi)^2+cos(pi)^2");
        assertEquals("1.0", calculator.solveExpression());
    }
    ...
    public void testAdvanced() {
        ...
        calculator.setUp("ln(1+(1+1))");
        assertEquals("1.0986122886681098", calculator.solveExpression());

        calculator.setUp("ln(746+23413.303+(-3855/12)-3+3)");
