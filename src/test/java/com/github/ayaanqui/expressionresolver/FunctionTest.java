...
public class FunctionTest {
    ...
    public void basicFunctionTest() {
        ...
        assertEquals(Math.sin(Math.PI), res.result, 0.0000000000000001);

        res = resolver.setExpression("cos(pi)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.cos(Math.PI), res.result, 0.0000000000000001);

        res = resolver.setExpression("tan(pi)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.tan(Math.PI), res.result, 0.0000000000000001);

        res = resolver.setExpression("ln(67)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.log(67), res.result, 0.0000000000000001);

        res = resolver.setExpression("sqrt(4748)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.sqrt(4748), res.result, 0.0000000000000001);

        res = resolver.setExpression("deg(2*pi)").solveExpression();
        assertTrue(res.success);
        assertEquals(new Double(360), res.result, 0.0000000000000001);

        res = resolver.setExpression("log(67, e)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.log(67) / Math.log(Math.E), res.result, 0.0000000000000001);

        res = resolver.setExpression("log(34758755, 67.34)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.log(34758755) / Math.log(67.34), res.result, 0.0000000000000001);

        res = resolver.setExpression("abs(-tau)").solveExpression();
        assertTrue(res.success);
        assertEquals(2 * Math.PI, res.result, 0.0000000000000001);

        res = resolver.setExpression("exp(100)").solveExpression();
        assertTrue(res.success);
        assertEquals(Math.exp(100), res.result, 0.0000000000000001);

        res = resolver.setExpression("avg(1,2,3,4)").solveExpression();
        assertTrue(res.success);
        assertEquals(2.5, res.result, 0.0000000000000001);

        res = resolver.setExpression("sum(1,2,3,4)").solveExpression();
        assertTrue(res.success);
        assertEquals(10, res.result, 0.0000000000000001);
    }
    ...
    public void nestedMultiParamFunctionTest() {
        ...
        res = resolver.setExpression("sum(sin(574)^2+cos(574)^2, 2, 4563+26444/exp(12), 3, -99, 2050, pi)")
                .solveExpression();
        assertTrue(res.success);
        assertEquals(1.0 + 2 + (4563 + 26444 / Math.exp(12)) + 3 + (-99) + 2050 + Math.PI, res.result,
                0.0000000000000001);
    ...
    public void setFunctionTest() {
        ...
        assertTrue(res.success);
        assertEquals(-1 - 2 - 3 - 4 - 5, res.result, 0.0000000000000001);
        ...
        assertTrue(res.success);
        assertEquals(Math.PI, res.result, 0.0000000000000001);
    }
}
